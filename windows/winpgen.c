    ...
    switch (msg) {
      case WM_INITDIALOG:
        ...
        SetWindowLongPtr(hwnd, GWLP_USERDATA, (LONG_PTR) state);
        {
            ...
            AppendMenu(sysmenu, MF_POPUP | MF_ENABLED, (UINT_PTR) menu1, "&File");
            ...
            AppendMenu(sysmenu, MF_POPUP | MF_ENABLED, (UINT_PTR) menu1, "&Key");
            state->keymenu = menu1;
            ...
            AppendMenu(menu1, MF_ENABLED, IDC_EXPORT_SSHCOM,
                       "Export &ssh.com key");
            AppendMenu(sysmenu, MF_POPUP | MF_ENABLED, (UINT_PTR) menu1,
                       "Con&versions");
            state->cvtmenu = menu1;
            ...
            AppendMenu(sysmenu, MF_POPUP | MF_ENABLED, (UINT_PTR) menu1, "&Help");
        }
